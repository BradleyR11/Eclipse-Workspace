...
public class CeasarCipher {
		static Scanner scanNum = new Scanner(System.in); //  scans number input
		static Scanner scanString = new Scanner(System.in); // scans string you want to encrypt/decrypt
		static String text; // 
		...
		public static void CaesarEncrypter(String plainText, int shiftValue) {
			...
			plainText = plainText.toLowerCase(); //turns all the letters inside plainText to lower case
			text = "";
		...
		public static void Chooser() {
			...
			if(choice == 1) {//if user chooses encryption function continue
				...
				String plainText = scanString.nextLine();
				...
				String encryptedText = scanString.nextLine();
	...
	public static void main(String[] args) {
		...
		System.out.println("Your encrypted/decrypted text is: " + text);//prints out the words and the value inside the variable text
