...
public class TestInvoice1 {
	...
	public static void main(String[] args) {
		...
		Customer c = new Customer("Evil lair", "Dr. Doofenshmirtz", 1234.50); // This will create a new customer using the provided info
		Invoice in = new Invoice(c); // This creates a new invoice for the customer
		in.addToOrder(new Product("flame Thower",163.80), 5); // This adds the product to the customer's order
