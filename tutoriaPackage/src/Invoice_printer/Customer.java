package Invoice_printer;

public class Customer {

	private String secretLair; // The customer's lair location
	 ...
	 * @param secretLair - It's the lair location for the customer
	 * @param name - the name of the customer
	 * @param evilFunds -the amount of money that the customer has
	 */
	public Customer(String secretLair, String name, double evilFunds) { // This will fill the variables with values from the parameters
		this.secretLair = secretLair;
		this.name = name;
	...
	public String toString() { // This returns the values of all the variables in the Customer method
		return ("Location: " + secretLair + " Name: " + name + " Money: " + evilFunds); 
